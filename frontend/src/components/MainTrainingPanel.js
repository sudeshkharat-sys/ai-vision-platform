                                        ...
                                        <div style={{ marginTop: 10, padding: '10px 12px', background: '#f9f9f9', borderRadius: 8, border: '1px solid #e5e5e5' }}>
                                            <div className="mtp-toggle-row">
                                                <label className="mtp-toggle-label">
                                                    ...
                                                    <span className="mtp-toggle-slider" />
                                                    <span className="mtp-toggle-text">Flip Left/Right <span className="mtp-toggle-hint">(disable for nameplate/text projects)</span></span>
                                                </label>
                                            </div>
                                            <div className="mtp-toggle-row" style={{ marginTop: 8 }}>
                                                <label className="mtp-toggle-label">
                                                    ...
                                                    <span className="mtp-toggle-slider" />
                                                    <span className="mtp-toggle-text">Flip Upside Down <span className="mtp-toggle-hint">(disable for nameplate/orientation projects)</span></span>
                                                </label>
                                            </div>
                                            <div className="mtp-toggle-row" style={{ marginTop: 8 }}>
                                                <label className="mtp-toggle-label">
                                                    ...
                                                    <span className="mtp-toggle-slider" />
                                                    <span className="mtp-toggle-text">Mosaic <span className="mtp-toggle-hint">(disable for binary OK/NOT OK inspection)</span></span>
                                                </label>
                                            </div>
                                            <div style={{ marginTop: 10 }}>
