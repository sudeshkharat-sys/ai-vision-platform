                                        ...
                                        <div style={{ marginTop: 10, padding: '12px 14px', background: '#f9f9f9', borderRadius: 8, border: '1px solid #e5e5e5' }}>
                                            ...
                                            <div className="tp-toggle-row">
                                                <label className="tp-toggle-label">
                                                    ...
                                                    <span className="tp-toggle-slider" />
                                                    <span className="tp-toggle-text">Flip Left/Right <span title="Mirrors image horizontally (50% chance per image). Safe for symmetric objects like sensors or pipes. Disable for text, nameplates, or any object where left/right direction matters." style={{ cursor: 'help', color: '#aaa', fontSize: 11 }}>ⓘ</span></span>
                                                </label>
                                            </div>
                                            <div className="tp-toggle-row" style={{ marginTop: 8, marginBottom: 14 }}>
                                                <label className="tp-toggle-label">
                                                    ...
                                                    <span className="tp-toggle-slider" />
                                                    <span className="tp-toggle-text">Flip Upside Down <span title="Mirrors image vertically (10% chance per image). Safe for round/symmetric objects. Disable if upside-down changes meaning — e.g. nameplate M becomes W which is a different label." style={{ cursor: 'help', color: '#aaa', fontSize: 11 }}>ⓘ</span></span>
                                                </label>
                                            </div>
                                            ...
                                            <div className="tp-toggle-row">
                                                <label className="tp-toggle-label">
                                                    ...
                                                    <span className="tp-toggle-slider" />
                                                    <span className="tp-toggle-text">Mosaic <span title="Combines 4 training images into 1 grid each epoch. Good for multi-class detection projects. Disable for binary OK/NOT OK inspection — mixing OK and NOT OK images in one tile confuses the model." style={{ cursor: 'help', color: '#aaa', fontSize: 11 }}>ⓘ</span></span>
                                                </label>
                                            </div>
                                            ...
                                            <div style={{ marginTop: 10 }}>
                                                <span style={{ fontSize: 12, color: '#555' }}>Copy Paste: <strong>{augCopyPaste}</strong> <span title="Cuts detected objects from one image and pastes them into another. Helps when you have very few labeled examples of a class. Safe to keep at a low value (0.05)." style={{ cursor: 'help', color: '#aaa', fontSize: 11 }}>ⓘ</span></span>
